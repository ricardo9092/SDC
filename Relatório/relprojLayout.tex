...
Iniciados os servidores, o sistema pode ser testado com o comando \texttt{./run TestRemote --X--}, sendo X o número de composições que vão navegar o sistema durante o teste.
